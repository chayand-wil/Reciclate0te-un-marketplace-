  ...
  >
    <div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
      ...
      <nav class="flex items-center space-x-6 relative z-50">
        ...
        <router-link to="/recicla0te.com/bodeguero">Home</router-link>
        <router-link to="/recicla0te.com/bodeguero/rankin">Ranking</router-link>

        <router-link to="/recicla0te.com/bodeguero/nosotros"> Sobre Nosotros </router-link>
      ...
      <div class="flex items-center space-x-4 mr-4 sm:mr-8 lg:mr-16">
        ...
        <div>
          <router-link to="/recicla0te.com/bodeguero/mi_cuenta_clasificador">Mi Cuenta</router-link>
        </div>  
